 ...
 */
export const createProject = async (workspaceId: string, name: string): Promise<RailwayProject> => {
  try {
...
export const isServiceConnectedToGitHub = async (serviceId: string, environmentId: string): Promise<boolean> => {
  const query = `
		query ServiceInstance($serviceId: String!, $environmentId: String!) {
			serviceInstance(serviceId: $serviceId, environmentId: $environmentId) {
				id
 ...
 */
export const renameService = async (serviceId: string, name: string): Promise<void> => {
  const mutation = `
 ...
 */
export const getProjectVolumes = async (projectId: string): Promise<Array<{ id: string; name: string }>> => {
  const query = `
 ...
 * Rename a volume
 */
export const renameVolume = async (volumeId: string, name: string): Promise<void> => {
  const mutation = `
 ...
 */
export const getProjectEnvironments = async (projectId: string): Promise<Array<{ id: string; name: string }>> => {
  const query = `
 ...
 */
export const renameEnvironment = async (environmentId: string, newName: string): Promise<boolean> => {
  const mutation = `
 ...
 */
export const triggerServiceDeployment = async (serviceId: string, environmentId: string): Promise<void> => {
  const mutation = `
 ...
 */
export const getServiceDomain = async (serviceId: string, environmentId: string): Promise<string | null> => {
  const query = `
