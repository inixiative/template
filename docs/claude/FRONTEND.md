...
- [API Client Usage](#api-client-usage)
  - [apiQuery (For Queries)](#apiquery-for-queries)
  - [apiMutation (For Mutations)](#apimutation-for-mutations)
  - [Why Separate Wrappers?](#why-separate-wrappers)
...
- [Permissions (Frontend)](#permissions-frontend)
  - [Pattern](#pattern)
...
- [Shared Components](#shared-components)
  ...
  - [Settings Components](#settings-components)
    ...
    - [Example: Settings Layout](#example-settings-layout)
  - [Modal Components](#modal-components)
  - [Page Components](#page-components)
- [UI Primitives (@template/ui)](#ui-primitives-templateui)
  - [Component Organization](#component-organization)
  - [Standard Conditional Props](#standard-conditional-props)
  - [Button](#button)
...
- [Hooks](#hooks)
  ...
  - [Navigation Hooks](#navigation-hooks)
    - [Navigation Store Methods](#navigation-store-methods)
  ...
  - [Utility Hooks](#utility-hooks)
    ...
    - [useValidateUniqueness](#usevalidateuniqueness)
- [Theme System](#theme-system)
  - [Architecture](#architecture)
  - [Hooks](#hooks)
    - [useThemePersistence](#usethemepersistence)
    - [useDarkMode](#usedarkmode)
    - [useSpaceTheme](#usespacetheme)
  ...
  - [Types](#types)
    ...
    - [AppTheme](#apptheme)
  - [Usage in Root Component](#usage-in-root-component)
  - [Testing](#testing)
  - [White-Labeling Flow](#white-labeling-flow)
  - [Key Benefits](#key-benefits)
- [Patterns](#patterns)
  - [1. Route Guards](#1-route-guards)
  - [2. Store Access](#2-store-access)
  - [3. Permission Checks](#3-permission-checks)
  - [4. Optimistic Mutations](#4-optimistic-mutations)
  - [5. Context Switching](#5-context-switching)
  - [6. Debounced Validation](#6-debounced-validation)
- [Data Hooks](#data-hooks)
  - [Architecture](#architecture)
  - [makeDataConfig](#makedataconfig)
  - [usePaginatedData — Page-Number Pagination](#usepaginateddata--page-number-pagination)
  - [useInfiniteData — Infinite Scroll](#useinfinitedata--infinite-scroll)
  - [Table Component](#table-component)
  - [Pagination Component](#pagination-component)
  - [Scroll Restoration — useScrollState](#scroll-restoration--usescrollstate)
  - [Section Hash — useSectionHash](#section-hash--usesectionhash)
  - [Infinite Scroll Trigger — useInfiniteScrollTrigger](#infinite-scroll-trigger--useinfinitescrolltrigger)
  - [State Persistence](#state-persistence)
  - [Testing](#testing)
- [App Differences](#app-differences)
...
- `serializeBracketQuery.test.ts` — 20 tests (bracket notation)
