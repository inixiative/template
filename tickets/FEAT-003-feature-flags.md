...
model FeatureFlagVariant {
  ...
  internalSegment Segment? @relation("FeatureFlagVariantInternalSegment")
...
// On Segment (FEAT-021):
//   featureFlagVariantId String? @unique @db.VarChar(36)   — set ⇒ internal: owned by, deleted with,
