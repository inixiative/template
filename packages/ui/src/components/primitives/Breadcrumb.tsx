...
const Breadcrumb = React.forwardRef<
  HTMLElement,
  React.ComponentPropsWithoutRef<'nav'> & { separator?: React.ReactNode; label?: string }
>(({ label, ...props }, ref) => <nav ref={ref} aria-label={label} {...props} />);
...
const BreadcrumbEllipsis = ({ className, srLabel, ...props }: React.ComponentProps<'span'> & { srLabel?: string }) => (
  <span
    role="presentation"
    aria-hidden="true"
