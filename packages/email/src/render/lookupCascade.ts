...
export const lookupCascade = async (
  ...
  // Null-proto + own-property probe: `constructor` matches the slug regex but would otherwise
  // resolve to Object.prototype.constructor and register a phantom component.
