...
// Calling codes are the country/region prefix used after the leading "+" in
// E.164 phone numbers (e.g. United States = "1" → +1 555..., Israel = "972" → +972 50...).
// Some territories share a calling code with their parent country (e.g. Puerto Rico
// uses +1 like the US); we include them with the parent's calling code.
export const COUNTRIES = [
  ...
  { code: 'KP', name: "Korea (Democratic People's Republic)", callingCode: '850' },
  ...
  { code: 'SX', name: 'Sint Maarten (Dutch part)', callingCode: '1' },
  ...
  { code: 'VA', name: 'Holy See (Vatican)', callingCode: '39' },
  { code: 'VC', name: 'Saint Vincent and the Grenadines', callingCode: '1' },
  { code: 'VE', name: 'Venezuela', callingCode: '58' },
  { code: 'VG', name: 'Virgin Islands (British)', callingCode: '1' },
  { code: 'VI', name: 'Virgin Islands (U.S.)', callingCode: '1' },
