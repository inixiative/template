...
// Offset and abbreviation are NOT stored statically — they shift with DST and
// political changes. Use `currentOffsetMinutes(tz)` to derive at runtime.
//
// Source: IANA tzdata canonical zone list. Aliases like 'US/Pacific' or
// 'Asia/Calcutta' are intentionally omitted in favor of canonical names like
...
export const currentOffsetMinutes = (tz: TimezoneId, at: Date = new Date()): number => {
