...
export const InquiryFindFirstSelectSchema: z.ZodType<Prisma.InquirySelect> = z.object({
...
export const InquiryFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
    sentAt: z.boolean().optional(),
...
export const InquiryFindFirstSchema: z.ZodType<Prisma.InquiryFindFirstArgs> = z.object({ select: InquiryFindFirstSelectSchema.optional(), include: z.lazy(() => InquiryIncludeObjectSchema.optional()), orderBy: z.union([InquiryOrderByWithRelationInputObjectSchema, InquiryOrderByWithRelationInputObjectSchema.array()]).optional(), where: InquiryWhereInputObjectSchema.optional(), cursor: InquiryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InquiryScalarFieldEnumSchema, InquiryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.InquiryFindFirstArgs>;

export const InquiryFindFirstZodSchema = z.object({ select: InquiryFindFirstSelectSchema.optional(), include: z.lazy(() => InquiryIncludeObjectSchema.optional()), orderBy: z.union([InquiryOrderByWithRelationInputObjectSchema, InquiryOrderByWithRelationInputObjectSchema.array()]).optional(), where: InquiryWhereInputObjectSchema.optional(), cursor: InquiryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InquiryScalarFieldEnumSchema, InquiryScalarFieldEnumSchema.array()]).optional() }).strict();