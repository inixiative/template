...
export const CronJobFindFirstSelectSchema: z.ZodType<Prisma.CronJobSelect> = z.object({
...
export const CronJobFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const CronJobFindFirstSchema: z.ZodType<Prisma.CronJobFindFirstArgs> = z.object({ select: CronJobFindFirstSelectSchema.optional(), include: z.lazy(() => CronJobIncludeObjectSchema.optional()), orderBy: z.union([CronJobOrderByWithRelationInputObjectSchema, CronJobOrderByWithRelationInputObjectSchema.array()]).optional(), where: CronJobWhereInputObjectSchema.optional(), cursor: CronJobWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CronJobScalarFieldEnumSchema, CronJobScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CronJobFindFirstArgs>;

export const CronJobFindFirstZodSchema = z.object({ select: CronJobFindFirstSelectSchema.optional(), include: z.lazy(() => CronJobIncludeObjectSchema.optional()), orderBy: z.union([CronJobOrderByWithRelationInputObjectSchema, CronJobOrderByWithRelationInputObjectSchema.array()]).optional(), where: CronJobWhereInputObjectSchema.optional(), cursor: CronJobWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CronJobScalarFieldEnumSchema, CronJobScalarFieldEnumSchema.array()]).optional() }).strict();