...
export const OrganizationUserFindManySelectSchema: z.ZodType<Prisma.OrganizationUserSelect> = z.object({
...
export const OrganizationUserFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    organizationId: z.boolean().optional(),
    userId: z.boolean().optional(),
    role: z.boolean().optional(),
