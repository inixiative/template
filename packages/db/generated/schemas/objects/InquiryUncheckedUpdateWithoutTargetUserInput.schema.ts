...
const makeSchema = () => z.object({
  ...
  sourceUserId: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  sourceOrganizationId: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  ...
  targetOrganizationId: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable()
}).strict();
export const InquiryUncheckedUpdateWithoutTargetUserInputObjectSchema: z.ZodType<Prisma.InquiryUncheckedUpdateWithoutTargetUserInput> = makeSchema() as unknown as z.ZodType<Prisma.InquiryUncheckedUpdateWithoutTargetUserInput>;
export const InquiryUncheckedUpdateWithoutTargetUserInputObjectZodSchema = makeSchema();
