...
export const InquiryFindManySelectSchema: z.ZodType<Prisma.InquirySelect> = z.object({
...
export const InquiryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
    sentAt: z.boolean().optional(),
...
export const InquiryFindManySchema: z.ZodType<Prisma.InquiryFindManyArgs> = z.object({ select: InquiryFindManySelectSchema.optional(), include: z.lazy(() => InquiryIncludeObjectSchema.optional()), orderBy: z.union([InquiryOrderByWithRelationInputObjectSchema, InquiryOrderByWithRelationInputObjectSchema.array()]).optional(), where: InquiryWhereInputObjectSchema.optional(), cursor: InquiryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InquiryScalarFieldEnumSchema, InquiryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.InquiryFindManyArgs>;

export const InquiryFindManyZodSchema = z.object({ select: InquiryFindManySelectSchema.optional(), include: z.lazy(() => InquiryIncludeObjectSchema.optional()), orderBy: z.union([InquiryOrderByWithRelationInputObjectSchema, InquiryOrderByWithRelationInputObjectSchema.array()]).optional(), where: InquiryWhereInputObjectSchema.optional(), cursor: InquiryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InquiryScalarFieldEnumSchema, InquiryScalarFieldEnumSchema.array()]).optional() }).strict();