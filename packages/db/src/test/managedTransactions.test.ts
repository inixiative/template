...
import { readExecutingTransaction } from '@template/db/extensions/mutationLifeCycle';
...
// readExecutingTransaction() in extensions/mutationLifeCycle.ts at the new location; do not
        ...
        query: {
          $allModels: {
            async findFirst(params) {
              observedTransactions.push(readExecutingTransaction(params));
