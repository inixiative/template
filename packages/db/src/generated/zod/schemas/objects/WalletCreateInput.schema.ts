...
import { UserCreateNestedOneWithoutWalletsInputObjectSchema as UserCreateNestedOneWithoutWalletsInputObjectSchema } from './UserCreateNestedOneWithoutWalletsInput.schema'
...
const makeSchema = () => z.object({
  ...
  user: z.lazy(() => UserCreateNestedOneWithoutWalletsInputObjectSchema)
}).strict();
