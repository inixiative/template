...
const makeSchema = () => z.object({
  ...
  targetOrganizationId: z.union([z.string().max(36), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable()
}).strict();
export const InquiryUncheckedUpdateManyWithoutSourceOrganizationInputObjectSchema: z.ZodType<Prisma.InquiryUncheckedUpdateManyWithoutSourceOrganizationInput> = makeSchema() as unknown as z.ZodType<Prisma.InquiryUncheckedUpdateManyWithoutSourceOrganizationInput>;
export const InquiryUncheckedUpdateManyWithoutSourceOrganizationInputObjectZodSchema = makeSchema();
