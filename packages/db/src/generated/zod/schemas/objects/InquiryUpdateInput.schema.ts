...
import { UserUpdateOneWithoutInquiriesSentNestedInputObjectSchema as UserUpdateOneWithoutInquiriesSentNestedInputObjectSchema } from './UserUpdateOneWithoutInquiriesSentNestedInput.schema';
import { OrganizationUpdateOneWithoutInquiriesSentNestedInputObjectSchema as OrganizationUpdateOneWithoutInquiriesSentNestedInputObjectSchema } from './OrganizationUpdateOneWithoutInquiriesSentNestedInput.schema';
import { UserUpdateOneWithoutInquiriesReceivedNestedInputObjectSchema as UserUpdateOneWithoutInquiriesReceivedNestedInputObjectSchema } from './UserUpdateOneWithoutInquiriesReceivedNestedInput.schema';
import { OrganizationUpdateOneWithoutInquiriesReceivedNestedInputObjectSchema as OrganizationUpdateOneWithoutInquiriesReceivedNestedInputObjectSchema } from './OrganizationUpdateOneWithoutInquiriesReceivedNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  sourceUser: z.lazy(() => UserUpdateOneWithoutInquiriesSentNestedInputObjectSchema).optional(),
  sourceOrganization: z.lazy(() => OrganizationUpdateOneWithoutInquiriesSentNestedInputObjectSchema).optional(),
  targetUser: z.lazy(() => UserUpdateOneWithoutInquiriesReceivedNestedInputObjectSchema).optional(),
  targetOrganization: z.lazy(() => OrganizationUpdateOneWithoutInquiriesReceivedNestedInputObjectSchema).optional()
}).strict();
export const InquiryUpdateInputObjectSchema: z.ZodType<Prisma.InquiryUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.InquiryUpdateInput>;
export const InquiryUpdateInputObjectZodSchema = makeSchema();
