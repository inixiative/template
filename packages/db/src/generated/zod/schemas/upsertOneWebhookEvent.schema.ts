...
export const WebhookEventUpsertOneSchema: z.ZodType<Prisma.WebhookEventUpsertArgs> = z.object({ select: WebhookEventSelectObjectSchema.optional(), include: WebhookEventIncludeObjectSchema.optional(), where: WebhookEventWhereUniqueInputObjectSchema, create: z.union([ WebhookEventCreateInputObjectSchema, WebhookEventUncheckedCreateInputObjectSchema ]), update: z.union([ WebhookEventUpdateInputObjectSchema, WebhookEventUncheckedUpdateInputObjectSchema ]) }).strict() as unknown as z.ZodType<Prisma.WebhookEventUpsertArgs>;

export const WebhookEventUpsertOneZodSchema = z.object({ select: WebhookEventSelectObjectSchema.optional(), include: WebhookEventIncludeObjectSchema.optional(), where: WebhookEventWhereUniqueInputObjectSchema, create: z.union([ WebhookEventCreateInputObjectSchema, WebhookEventUncheckedCreateInputObjectSchema ]), update: z.union([ WebhookEventUpdateInputObjectSchema, WebhookEventUncheckedUpdateInputObjectSchema ]) }).strict();