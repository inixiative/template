import { Home, Users, Settings, BarChart, Shield, Database, Building2, Mail } from 'lucide-react';
  ...
  organization: [
    {
      items: [
        ...
        },
        {
          ...
          icon: BarChart,
          can: (p, ctx) =>
            ctx.organization ? p.check('organization', ctx.organization, 'operate') : false,
        },
        {
          label: 'Users',
