...
const PublicLayout = () => {
  ...
  // Sibling-app links are only shown when the URL is provided AND the app is
  // enabled. Disabled-feature apps don't deploy a URL so the env var stays
  // empty; conditional rendering keeps the nav clean for single-app projects
  // (e.g. tribe = superadmin only).
