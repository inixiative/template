 ...
 * @uses none
 */
import { DbAction, db, type HookOptions, HookTiming, registerDbHook, toAccessor } from '@template/db';
...
const delegateFor = (model: string): Delegate => db[toAccessor(model)] as unknown as Delegate;
