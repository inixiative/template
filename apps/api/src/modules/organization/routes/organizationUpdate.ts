import { OrganizationScalarInputSchema, OrganizationScalarSchema } from '@template/db';
...
export const organizationUpdateRoute = updateRoute({
  ...
  bodySchema: OrganizationScalarInputSchema.pick({ name: true, slug: true }).partial(),
