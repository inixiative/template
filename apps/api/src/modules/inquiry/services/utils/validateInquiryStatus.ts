...
export const assertInquiryIsDraft = (inquiry: Inquiry): void => {
...
export const assertInquiryIsEditable = (inquiry: Inquiry): void => {
...
export const assertInquiryIsResolvable = (inquiry: Inquiry): void => {
...
export const assertInquiryIsCancelable = (inquiry: Inquiry): void => {
